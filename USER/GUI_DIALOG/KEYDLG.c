					...
					*pPath='\0';
					...
					if(*pPath=='.')
					{
						...
						if(fresult==FR_EXIST)
							...
							{
								hNode=TREEVIEW_InsertItem(hTree,TREEVIEW_ITEM_TYPE_LEAF,hNode,TREEVIEW_INSERT_BELOW,Buff/*finfo.fname*/);		
					...
					else
					{
						...
						if(fresult==FR_EXIST)
							...
							{
								hNode=TREEVIEW_InsertItem(hTree,TREEVIEW_ITEM_TYPE_NODE,hNode,TREEVIEW_INSERT_BELOW,Buff/*finfo.fname*/);
								GUI_EndDialog(pMsg->hWin,0);
								*pPath='\0';
							}
					}
