...
*       _aERROR_TIMER
*/
static const GUI_WIDGET_CREATE_INFO _aERROR_TIMER[] = {
  { FRAMEWIN_CreateIndirect, "ERROR", ID_FRAMEWIN_0, 120, 50, 150, 130, 0, 0x64, 0 },
	{ BUTTON_CreateIndirect, "OK", ID_BUTTON_2, 40, 40, 50, 30, 0, 0x0, 0 },
   { TEXT_CreateIndirect, "Text", ID_TEXT_0, 10, 20, 120, 20, 0, 0x0, 0 },
  // USER END
};

static void _cbERROR_TIMER(WM_MESSAGE * pMsg) {
  int     NCode;
  int     Id;
	WM_HWIN hItem;
	switch (pMsg->MsgId) {
			...
			BUTTON_SetText(hItem, "OK");
				...
				TEXT_SetText(hItem,"STOP THE TIMER!!!");
			break;
...
static const GUI_WIDGET_CREATE_INFO _aTIMER[] = {
  { FRAMEWIN_CreateIndirect, "TIMER", ID_FRAMEWIN_0, 100, 5, 300, 200, 0, 0x64, 0 },
...
WM_HWIN CreateError(void){
	hWin_error=GUI_CreateDialogBox(_aERROR_TIMER, GUI_COUNTOF(_aERROR_TIMER), _cbERROR_TIMER, hWin_timer, 0, 0);
	return hWin_error;
}
