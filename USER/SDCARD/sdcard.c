...
#define SDIO_INIT_CLK_DIV                  ((u8)0x94)
...
SD_Error SD_PowerON(void)
{
  ...
  /* Power ON Sequence -------------------------------------------------------*/
  /* Configure the SDIO peripheral */
  SDIO_InitStructure.SDIO_ClockDiv = SDIO_INIT_CLK_DIV; /*400kHz = SDIOCLK(48MHz) / [CLKDIV + 2].*/
  SDIO_InitStructure.SDIO_ClockEdge = SDIO_ClockEdge_Rising;
  SDIO_InitStructure.SDIO_ClockBypass = SDIO_ClockBypass_Disable;
...
/**************************************************************************************/
/*										Настройка выводов для модуля SDIO																*/
/**************************************************************************************/
...
static void DMA_TxConfiguration(u32 *BufferSRC, u32 BufferSize)
{
  ...
  DMA_Cmd(DMA2_Stream3, DISABLE);
	...
	//	DMA2 Channel 4 Stream3 -Tx
	DMA_InitStruct.DMA_BufferSize=0;
	DMA_InitStruct.DMA_Channel=DMA_Channel_4;
	DMA_InitStruct.DMA_DIR=DMA_DIR_MemoryToPeripheral;
	DMA_InitStruct.DMA_FIFOMode=DMA_FIFOMode_Enable;
	DMA_InitStruct.DMA_FIFOThreshold=DMA_FIFOThreshold_Full;
	DMA_InitStruct.DMA_Memory0BaseAddr=(u32)BufferSRC;
...
static void DMA_RxConfiguration(u32 *BufferDST, u32 BufferSize)
{
  ...
  DMA_Cmd(DMA2_Stream3, DISABLE);
	...
	DMA_InitStruct.DMA_FIFOMode=DMA_FIFOMode_Enable;
	DMA_InitStruct.DMA_FIFOThreshold=DMA_FIFOThreshold_Full;
	DMA_InitStruct.DMA_Memory0BaseAddr=(u32)BufferDST;
	DMA_InitStruct.DMA_MemoryBurst=DMA_MemoryBurst_INC4;
	DMA_InitStruct.DMA_MemoryDataSize=DMA_MemoryDataSize_Word;
	DMA_InitStruct.DMA_MemoryInc=DMA_MemoryInc_Enable;
	DMA_InitStruct.DMA_Mode=DMA_Mode_Normal;
